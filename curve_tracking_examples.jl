...
x,r,A=track_curve(F,p,.1,2000,"~/Documents/GitHub/certified_curve_projections/KRTZ"; 
                    show_tubular_neighborhood=true, 
                    figure_scale=1,
                    box_thickness=0.05,
                    line_thickness=0.05
...
x,r,A=track_curve(F,p,.1,500,"~/Documents/GitHub/certified_curve_projections/MGGJ")
